      ...
      <div class="col-12">
        <div class="card my-4">
          <div class="card-header p-0 position-relative mt-4 mx-3 z-index-2">
            ...
            <form method="post" action="action/gejalaTambah.php" role="form">

                <div class="input-group input-group-outline mb-3 mt-5">
                  <!-- <label class="form-label">Email</label> -->
                  <input type="text" name="id" class="form-control" placeholder="Id gejala">
                </div>
                    
                <div class="input-group input-group-outline mb-3">
                  <!-- <label class="form-label">Email</label> -->
                  <input type="text" name="nama" class="form-control" placeholder="Nama gejala">
                </div>

...
$result = mysqli_query($conn, "SELECT * FROM tbl_gejala WHERE id_gejala ='".$_GET['id']."'");
    ...
    <div class="container-fluid py-1 px-3">
      ...
      <nav aria-label="breadcrumb">
        ...
        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
          <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark" href="gejala.php">Gejala</a></li>
          <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Edit Gejala</li>
        </ol>
        ...
        <div class="card my-4">
          <div class="card-header p-0 position-relative mt-4 mx-3 z-index-2">
            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
              <h6 class="text-white text-capitalize ps-3">Edit Gejala</h6>
            </div>
            <form method="post" action="action/editGejala.php" role="form">
                <div class="input-group input-group-outline mb-3 mt-5">
                  <!-- <label class="form-label">Email</label> -->
                  <input type="text" value="<?= $gejala['id_gejala'] ?>" name="id" class="form-control" placeholder="id" readonly>
                </div>
                <div class="input-group input-group-outline mb-3">
                  <!-- <label class="form-label">Email</label> -->
                  <input type="text" value="<?= $gejala['name'] ?>" name="nama" class="form-control" placeholder="Nama penyakit">
                </div>

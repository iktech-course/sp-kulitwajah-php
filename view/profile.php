            ...
            <div class=" card sm:w-1/2 sm:h-max mx-auto gap-0 bg-white mt-5 p-5 text-black">
                ...
                <input type="hidden" name="user_id" class="form-control" id="user_id" value="<?php echo @$user['user_id']?>" >
                    ...
                    <div class="lg:grid lg:grid-cols-2 gap-0">
                        ...
                        <div class="mt-5">
                            <label class="my-5">Tanggal lahir</label>
                            
                                <div class="flex datepicker " data-mdb-toggle-button="false">
                                <input datepicker type="date" id="tanggal_lahir" class="border  border-black rounded text-black px-4 py-1" style="border-color: black;" value="<?= $user['tanggal_lahir'] ?>" placeholder="Pilih tanggal lahir">
                                </div>
                        </div>
                    </div>
                    ...
                    <div class="mt-5">
                        <label class="my-5 required:border-red-500" for="">Password</label>
                        <div class="flex">
                            <input id="password" type="password" class="px-4 py-1 border border-black rounded text-black" value="<?php echo @$_SESSION['password']?>" placeholder="Masukkan password anda" required/>
                        </div>
